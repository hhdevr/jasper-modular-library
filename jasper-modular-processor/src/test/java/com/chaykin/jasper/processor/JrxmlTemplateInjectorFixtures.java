...
final class JrxmlTemplateInjectorFixtures {
    ...
    static final String COLLECTION_PARAM_CLASS = "net.sf.jasperreports.engine.data.JRBeanCollectionDataSource";
    ...
    static List<JrxmlParameter> collectionParam() {
        ...
        JrxmlDataset dataset = new JrxmlDataset(DATASET_NAME, List.of(field));
        return List.of(
    ...
    static List<JrxmlParameter> existingDatasetParam() {
        ...
        JrxmlDataset dataset = new JrxmlDataset(EXISTING_DATASET_NAME, List.of(field));
        return List.of(
